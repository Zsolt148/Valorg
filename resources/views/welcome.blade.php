...
<div id="wrapper" class="clearfix">
                ...
                <div class="col-12 col-md-auto">
                    ...
                    <div class="top-links">
                        <ul class="top-links-container">
                            <li class="top-links-item"><a href="#">Kezdőlap</a></li>
                            <li class="top-links-item"><a href="#">FAQs</a></li>
                            <li class="top-links-item"><a href="#">Belépés</a></li>
                        </ul>
                    </div><!-- .top-links end -->
                ...
                <div class="header-row">
                    ...
                    <nav class="primary-menu with-arrows">
                        ...
                        <ul class="menu-container">
                            <li class="menu-item current"><a class="menu-link" href="/"><div>Kezdőlap</div></a></li>
                            <li class="menu-item"><a class="menu-link" href="#"><div>Hírek</div></a></li>
                            <li class="menu-item"><a class="menu-link" href="#about-us" data-scrollto="#about-us"><div>Rólunk</div></a></li>
                            <li class="menu-item mega-menu"><div class="menu-link"><div>Szolgáltatásaink</div></div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="mega-menu-column sub-menu-container col-12 p-0">
                                                <a href="#" class="button button-rounded button-large nott ls0 btn-block text-center m-0 rounded-0 py-3 button-light ">Összes megtekintése<i class="icon-line-arrow-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="menu-item"><a class="menu-link" href="#"><div>Cégeknek</div></a></li>
                            <li class="menu-item"><a class="menu-link" href="#contact" data-scrollto="#contact"><div>Kapcsolat</div></a></li>
                        </ul>
    ...
    <section id="slider" class="slider-element slider-parallax min-vh-60 min-vh-md-100 include-header">
        <div class="slider-inner" style="background: #FFF url('images/wallpaper.jpg') center center no-repeat; background-size: cover;">
                    ...
                    <div class="row pt-5">
                        <div class="col-lg-5 col-md-8">
                            <div class="slider-title">
                                ...
                                <h3 class="text-rotater mb-2" data-separator="," data-rotate="fadeIn" data-speed="2500">Professzionális <span class="t-rotate">Könyvelés,Tanácsadás</span> kis-, és középvállalkozásoknak.</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quia vitae mollitia dignissimos ab qui aspernatur.</p>
                                <a href="#" class="button button-rounded button-large nott ls0">Cégeinknek</a>
                                <a href="#contact" data-scrollto="#contact" class="button button-rounded button-large button-light text-dark bg-white border nott ls0">Kapcsolat</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="content">
        ...
        <div class="content-wrap pt-0">
            ...
            <div class="section bg-transparent mt-4 mb-0 pb-0">
                <div class="container">
                    <div class="heading-block border-bottom-0 center mx-auto mb-0" style="max-width: 550px">
                        ...
                        <p> A mindennapi munka során keletkezett számlák, bizonylatok könyvelésén, a szerződések, okiratok megszerkesztésén keresztül az üzletviteli tanácsadásig és a felsoroltakkal együtt járó teljes körű ügyintézésig.</p>
                    </div>
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="feature-box flex-md-row-reverse text-md-right border-0">
                                ...
                                <div class="fbox-content">
                                    <h3 class="nott ls0">Tanácsadás</h3>
                            ...
                            <div class="feature-box flex-md-row-reverse text-md-right border-0 mt-5">
                                ...
                                <div class="fbox-content">
                                    <h3 class="nott ls0">Bér és munkaügy</h3>
                        ...
                        <div class="col-lg-3 col-7 offset-3 offset-sm-0 d-sm-none d-lg-block center my-5">
                            <img src="images/section2.jpg" alt="" class="rounded" data-bottom-top="transform: translateY(-30px)" data-top-bottom="transform: translateY(30px)">
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="feature-box border-0">
                                ...
                                <div class="fbox-content">
                                    <h3 class="nott ls0">Hitelügyintézés</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum, dolore, voluptates!</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-box border-0 mt-5">
                                ...
                                <div class="fbox-content">
                                    <h3 class="nott ls0">Pályázatok</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi, ipsa!</p>
                                </div>
                            </div>
                            ...
                            <div class="feature-box border-0 mt-5">
                                <div class="fbox-icon">
                                    <a href="#"><img src="demos/seo/images/icons/globe.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                </div>
                                <div class="fbox-content">
                                    <h3 class="nott ls0">Környezetvédelem</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam, provident.</p>
                                </div>
                            </div>
            ...
            <!-- About us
            ============================================= -->
            <div class="section m-0" style="background: url('demos/seo/images/sections/4.png') no-repeat center top; background-size: cover; padding: 140px 0 0;" id="about-us">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="badge badge-pill badge-default">Rólunk</div>
                            <h2 class="display-4 font-weight-bold">Tapasztalat.</h2>
                            <p>Könyvelő Irodánk 1993-ban alakult egyéni vállalkozásként, majd 1997-től Korlátolt Felelősségű Társaságként folytatjuk tevékenységünket.</p>
                            <a href="demo-seo-optimizations.html" class="button button-rounded button-large nott ls0">Bővebben</a>
                        </div>
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <img src="demos/seo/images/services/experience.svg" class="mb-4" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-6 col-md-4">
                            <div class="heading-block border-bottom-0 bottommargin-sm">
                                ...
                                <h3 class="nott ls0">Kapcsolatfelvétel menete</h3>
                            </div>
                            <p>Bármilyen kérdéssel fordulj hozzánk bizalommal</p>
                        </div>
                                    ...
                                    <div class="form-widget">
                                        ...
                                        <form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
                                            ...
                                            <div class="col-12 form-group mb-4">
                                                ...
                                                <textarea name="template-contactform-website" class="form-control input-sm required"></textarea>
                                            </div>
                                            <div class="col-12 form-group mb-0">
                                                <button class="button button-rounded btn-block nott ls0 m-0" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit">Küldés</button>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mt-5">
                            <div class="feature-box fbox-center border-0">
                                <div class="fbox-icon">
                                    <a href="#"><img src="demos/seo/images/icons/team.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                </div>
                                <div class="fbox-content">
                        ...
                        <div class="col-md-4 mt-5">
                            <div class="feature-box fbox-center border-0">
                                <div class="fbox-icon">
                                    <a href="#"><img src="demos/seo/images/icons/group.svg" alt="Feature Icon" class="bg-transparent rounded-0"></a>
                                </div>
                                <div class="fbox-content">
                ...
                <div class="row justify-content-between col-mb-30">
                    ...
                    <div class="col-12 col-lg-auto text-center text-lg-right">
                        <div class="copyrights-menu copyright-links clearfix">
                            <a href="#">Kezdőlap</a>/<a href="#">Hírek</a>/<a href="#">Rólunk</a>/<a href="#">Cégeknek</a>/<a href="#">Kapcsolat</a>
                        </div>
                    </div>
                </div>
