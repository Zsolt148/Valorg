...
@section('content')
    ...
    <section id="page-title" class="page-title-parallax page-title-center page-title include-header" style="background-image: linear-gradient(to top, rgba(254,150,3,0.5), #f0f0f7), url('images/wallpaper-min.jpg'); background-size: cover; padding: 120px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -700px;">
        ...
        <div class="container clearfix mt-4 text-black">
            ...
            <p data-class-xl="h1" data-class-lg="h1" data-class-md="h1" data-class-sm="h2" data-class-xs="h2" class="font-weight-bold">Hírek partnereinknek</p>
        </div>
                        ...
                        <div class="col-md-12">
                            <div class="heading-block border-bottom-0 mb-0">
                                @if(Cookie::get('confirmed') == 'confirmed' || Auth::user())
                                    ...
                                    <p>
                                        Az azonosítás összesen 2 óráig marad aktív, utána újra bekell írnia az adószámát. Ez idő alatt bármilyen hírt megnézhet és bármilyen fájlt letölthet.
                                    </p>
                                @else
                                    <h3 class="nott ls0 mb-3">A hírek megnézése csak a partnereinknek elérhető</h3>
                                    <p>
                                        Lépj velünk kapcsolatba hogy megtudd hogyan nézheted meg a híreinket.<br>
                                        Amennyiben cégünknél vagy partner vagy írd be a céged adószámának első 8 karakterét a mezőbe.
                                    </p>
