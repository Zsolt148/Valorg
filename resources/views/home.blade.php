...
@section('content')
    ...
    <section id="slider" class="slider-element slider-parallax min-vh-60 min-vh-md-100 include-header">
        <div class="slider-inner" style="background: #FFF url('images/wallpaper-white.png') center center no-repeat; background-size: cover;">
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-8">
                            <div class="slider-title">
                                <div>
                                    <img src="images/logo2.png" alt="logo" id="logo-png">
                                    <img src="images/logo.png" class="mb-4" width="50%" alt="logo" id="logo-png-mobile">
                                </div>
                                <h3 class="text-rotater mb-2" data-separator="|" data-rotate="fadeIn" data-speed="2500"><span class="t-rotate">Könyvelés|Bérszámfejtés</span>
                                    <br> kis-, és középvállalkozásoknak.</h3>
                                <p></p>
    ...
    <section id="content">
        ...
        <div class="content-wrap pt-0">
            ...
            <!-- Features
            ============================================= -->
            <div class="section bg-transparent mt-4 mb-4 pb-4">
                <div class="container">
                    ...
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            ...
                            <div class="feature-box flex-md-row-reverse text-md-right border-0 mt-4">
                                <div class="fbox-icon">
                        ...
                        <div class="col-lg-6 col-sm-6 offset-3 offset-sm-0 d-sm-none d-lg-block center my-5">
                            ...
                            <img src="images/mivel.jpeg" alt="mivel foglalkozunk" class="rounded-xl shadow">
                        </div>
            ...
            <!-- Form Section
				============================================= -->
            <div class="section m-0 mt-4" style="background: url('images/keyboard.png') no-repeat center center; background-size: cover; padding: 100px 0;">
                <div class="container">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            ...
                            <div class="mb-2">
                                <a href="http://www.parameter.hu/" target="_blank" class="text-larger">Parameter Bt. - Bérprogram</a>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <a href="http://studiokreart.hu/" target="_blank" class="text-larger">Studiokreart - Arculattervezés</a><br>
                            </div>
                            <div class="mb-2">
                                <a href=mailto:b.zsolt148@gmail.com" target="_blank" class="text-larger">Budai Zsolt - Weboldal készítés</a><br>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-4 mt-lg-0">
                            <img src="images/partnerek.jpeg" class="mb-4 rounded-xl shadow" alt="partnerek">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-5">
                            <div class="feature-box fbox-center border-0">
                                ...
                                <div class="fbox-content">
                                    <h3 class="nott ls0">2. Konzultáció</h3>
                                </div>
                            </div>
                        </div>
